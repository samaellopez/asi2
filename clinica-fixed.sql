...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 26, 2019 at 12:02 AM
...
(1, 'Marlene', 'Ramirez', '1996-04-12', 'F', 0, 'marbon@gmail.com', 76890912, '346578129-', '1205-021297-8768-', 'Dayana', 67890321, 'ninguna', 'Ninguno', '2019-09-24');
...
--
ALTER TABLE `pacientes`
  MODIFY `id_paciente` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
